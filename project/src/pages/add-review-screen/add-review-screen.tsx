...
function AddReviewScreen({ comment, onSendMessage }: ReviewProps): JSX.Element {
      ...
      <section className="film-card film-card--full">
        <div className="film-card__header">
          <div className="film-card__bg">
            <img src={filmInfoById.previewImage} alt={filmInfoById.name} />
          </div>
          ...
          <div className="film-card__poster film-card__poster--small">
            <img src={filmInfoById.posterImage} alt={`${filmInfoById.name} poster`} width="218" height="327" />
          </div>
        </div>
